...
class APKInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ab?.setSubtitle("Unified ScratchTappy Platform 8.0")
        val chart = findViewById<PieChart>(R.id.chart)
        val entries: MutableList<PieEntry> = ArrayList()
        entries.add(PieEntry(52.6f, "classes.dex"))
        entries.add(PieEntry(17.2f, "classes2.dex"))
        entries.add(PieEntry(16.4f, "res"))
        entries.add(PieEntry(8.1f, "assets"))
        entries.add(PieEntry(4.1f, "resources.arsc"))
        entries.add(PieEntry(1.4f, "META-INF"))
